...
static struct fb_var_screeninfo ls7a_fb_default __devinitdata = {
	.xres		= 1280,
	.yres		= 1024,
	.xres_virtual	= 1280,
	.yres_virtual	= 1024,
...
static struct fb_fix_screeninfo ls7a_fb_fix __devinitdata = {
	.id =		"Virtual FB",
				 ...
				 const struct pci_device_id *ent)
{
	...
	retval = request_irq(irq, ls7afb_irq, IRQF_DISABLED, pci_name(pdev), info);
	if (retval) {
...
#endif
	/* Prefer to use PCI-E Graphics Card */
